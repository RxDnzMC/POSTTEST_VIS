...
Public Class Form1
    ...
    Private Function CekData() As Boolean
        ...
        'isi array dari checkbox yang ada di form
        ...
        If Not ValidasiRadioButton(arrayJK, "Pilih Jenis Kelamin Anda") Then Return False
        If Not ValidasiCheckBox(arrayHobi, "Pilih Minimal 1 Hobi") Then Return False
